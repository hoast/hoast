...
- Convert into a single mono repository.
- Rewrite basically from the ground up.
- Convert from the `commander` to the `optionator` package for the command line package.
